...
import { generateHomePosts, generatePostPaths, getPostData } from '../../lib/posts'
...
export async function getStaticProps({ params }) {
  ...
  const sidePosts = await generateHomePosts();
...
export default function Post({ postData, tagList, sidePosts, req }) {
  ...
  return (<Layout tagList={tagList} sidePosts={sidePosts.topPosts}>
    <div className='container-border post-container'>
      ...
      <a class="resp-sharing-button__link" href={`https://facebook.com/sharer/sharer.php?u=${shareLink}`} target="_blank" rel="noopener" aria-label="Share on Facebook">
        <div class="resp-sharing-button resp-sharing-button--facebook resp-sharing-button--large"><div aria-hidden="true" class="resp-sharing-button__icon resp-sharing-button__icon--solidcircle">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 0C5.38 0 0 5.38 0 12s5.38 12 12 12 12-5.38 12-12S18.62 0 12 0zm3.6 11.5h-2.1v7h-3v-7h-2v-2h2V8.34c0-1.1.35-2.82 2.65-2.82h2.35v2.3h-1.4c-.25 0-.6.13-.6.66V9.5h2.34l-.24 2z" /></svg>
        </div>Share on Facebook</div>
      </a>

      <a class="resp-sharing-button__link" href={`https://twitter.com/intent/tweet/?text=${shareLink}`} target="_blank" rel="noopener" aria-label="Share on Twitter">
